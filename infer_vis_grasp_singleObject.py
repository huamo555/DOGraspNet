...
parser.add_argument('--dataset_root', default='/data_1/yaohuayang_data/Dataset/dataset-data')

parser.add_argument('--dump_dir', help='Dump dir to save outputs', default="/data_1/yaohuayang_data/adjustOffset/graspness_D_offset_cat/logs/realsense/test_10")
...
if __name__ == '__main__':
    ...
    #计算前五十的平均抓取得分
    #pdb.set_trace()
    confidence = gg.scores
    confidence_avg = np.max(confidence)
