...
def get_loss(end_points):
    ...
    loss1 = objectness_loss + 20* graspness_loss + 100 * view_loss + 50 * score_loss + 15 * width_loss
    #loss2 = objectness_loss + 20* graspness_loss + 100 * view_loss + 100 * score_loss + 30 * width_loss
    #loss3 = objectness_loss + 20* graspness_loss + 100 * view_loss + 100 * score_loss + 15 * width_loss
    
    end_points['loss/overall_loss'] = loss1
    return loss1, end_points
